...
::: {data-id="box2" style="background: `r colors$cambridgeBlue`; width: 350px; height: 15px; margin: 0px;"}
:::

::: {data-id="box3" style="background: `r colors$persianGreen`; width: 200px; height: 15px; margin: 0px;"}
:::

::: {data-id="box4" style="background: `r colors$satinSheenGold`; width: 120px; height: 15px; margin: 0px;"}
:::
::::
