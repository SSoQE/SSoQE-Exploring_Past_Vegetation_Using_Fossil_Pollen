...
::: {.incremental}
* **'Raw' Observations** on a variety of different proxies (vertebrates, diatoms, [pollen]{.text-highlight-byzantium}, plant macrofossils, testate amoebae, ostracodes, etc.)
  * [number of identified specimens]{.text-highlight-harvestGold}, minimum number of individuals, presence/absence
...
Notoma REST [API]{.text-highlight-byzantium} allows to directly send [SQL]{.text-highlight-harvestGold} queries from the Neotoma server.
...
::: {.column width="25%"}
Our interest is [Dataset]{.text-highlight-byzantium} and [Samples]{.text-highlight-harvestGold}.
:::
...
To assign [**age**]{.text-highlight-byzantium} to each [**depth**]{.text-highlight-harvestGold} in a [**core**]{.text-highlight-persianGreen}.
