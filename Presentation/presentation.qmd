...
* **Age inferences**
* [Derived Variables (e.g July mean temperature, species richness)]{.text-strike}
* [Image files]{.text-strike}
:::
...
* [💽Raw R code](`r ex1_path_qmd`)
* [🎨rendered R code](`r ex1_path_html`)
...
* [💽Raw R code](`r ex2_path_qmd`)
* [🎨rendered R code](`r ex2_path_html`)
...
* [💽Raw R code](`r ex3_path_qmd`)
* [🎨rendered R code](`r ex3_path_html`)
