...
include_local_figure("SSOQE_logo3.png")
```
...
:::: {.r-hstack}
::: {data-id="box1" style="background: `r colors$black`; width: 135px; height: 15px; margin: 0px;"}
:::

::: {data-id="box2" style="background: `r colors$cambridgeBlue`; width: 405px; height: 15px; margin: 0px;"}
:::

::: {data-id="box3" style="background: `r colors$persianGreen`; width: 225px; height: 15px; margin: 0px;"}
:::

::: {data-id="box4" style="background: `r colors$satinSheenGold`; width: 135px; height: 15px; margin: 0px;"}
:::
::::
...
[Science School of Quantitative Ecology 2024]{.text-color-black}
